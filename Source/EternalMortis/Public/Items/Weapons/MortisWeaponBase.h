...
DECLARE_DELEGATE_TwoParams(FOnWeaponHit, AActor*, const FHitResult&)
DECLARE_DELEGATE_OneParam(FOnWeaponPulled, AActor* HitActor)
...
public:	
	...
	FOnWeaponHit OnWeaponHitTarget;
	FOnWeaponPulled OnWeaponPulledFromTarget;
	...
	FORCEINLINE virtual const FMortisWeaponCommonData* GetCommonData() const { return nullptr; }
