...
void AMortisProjectileBase::OnSpawned(const FGameplayEffectSpecHandle& EffectSpecHandle)
{
	InitializeProjectile(EffectSpecHandle);
}
...
void AMortisProjectileBase::HandleProjectileImpact(AActor* OtherActor, const FHitResult& HitResult)
{
	...
	if (UMortisFunctionLibrary::HasGameplayTag(OtherActor, MortisGameplayTags::State_Invincible))
		return;
