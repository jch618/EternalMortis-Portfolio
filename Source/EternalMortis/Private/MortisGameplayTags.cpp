...
namespace MortisGameplayTags
{
	...
	UE_DEFINE_GAMEPLAY_TAG(InputTag_UI_DirectionalSelect, "InputTag.UI.DirectionalSelect");
	...
	// ====================		Character Tags		====================
	UE_DEFINE_GAMEPLAY_TAG(Character_Material_Stone, "Character.Material.Stone");
	UE_DEFINE_GAMEPLAY_TAG(Character_Material_Metal, "Character.Material.Metal");
	UE_DEFINE_GAMEPLAY_TAG(Character_Material_Bone, "Character.Material.Bone");
	UE_DEFINE_GAMEPLAY_TAG(Character_Material_Flesh, "Character.Material.Flesh");
	...
	UE_DEFINE_GAMEPLAY_TAG(Data_AttackStyle_Swing, "Data.AttackStyle.Swing");
	UE_DEFINE_GAMEPLAY_TAG(Data_AttackStyle_Slam, "Data.AttackStyle.Slam");
	UE_DEFINE_GAMEPLAY_TAG(Data_AttackStyle_Kick, "Data.AttackStyle.Kick");
	...
	// ====================		GameplayCue Tags	====================
	UE_DEFINE_GAMEPLAY_TAG(GameplayCue_Movement_Trail_Sevarog, "GameplayCue.Movement.Trail.Sevarog");
	UE_DEFINE_GAMEPLAY_TAG(GameplayCue_Combat_Hit, "GameplayCue.Combat.Hit");
	UE_DEFINE_GAMEPLAY_TAG(GameplayCue_Combat_Hit_Stone, "GameplayCue.Combat.Hit.Stone");
	UE_DEFINE_GAMEPLAY_TAG(GameplayCue_Combat_Hit_Metal, "GameplayCue.Combat.Hit.Metal");
	UE_DEFINE_GAMEPLAY_TAG(GameplayCue_Combat_Hit_Bone, "GameplayCue.Combat.Hit.Bone");
	UE_DEFINE_GAMEPLAY_TAG(GameplayCue_Combat_Hit_Flesh, "GameplayCue.Combat.Hit.Flesh");
	
	UE_DEFINE_GAMEPLAY_TAG(GameplayCue_Combat_Death, "GameplayCue.Combat.Death");
}